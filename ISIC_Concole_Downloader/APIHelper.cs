...
namespace ISIC_Concole_Downloader
{
    class APIHelper
    {
        ...
        /// <summary>
        /// Function to download a whole dataset from ISIC. Currently not used, because the ISIC api was upgraded and it does not provide an end point to download whole datasets.
        /// </summary>
